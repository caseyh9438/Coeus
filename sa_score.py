class SyntheticAccessibilityScore():
    """
    I copied this SyntheticAccessibilityScore class from this github repo: https://github.com/pulimeng/eToxPred/blob/master/sascore.py
    ...
    def readFragmentScores(self, name='fpscores'):
        ...
        _fscores = pickle.load(gzip.open("https://storage.googleapis.com/htr1/fpscores.pkl.gz"))
        outDict = {}
        for i in _fscores:
